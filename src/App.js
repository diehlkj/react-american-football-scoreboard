    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__touchdown" onClick={event => setHomeScore(homeScore + 6)}>Home Touchdown</button>
          <button className="homeButtons__fieldGoal" onClick={event => setHomeScore(homeScore + 3)}>Home Field Goal</button>
        </div>
        <div className="awayButtons">
          <button className="awayButtons__touchdown" onClick={event => setAwayScore(awayScore + 6)}>Away Touchdown</button>
